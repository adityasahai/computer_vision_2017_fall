function imdb = proj6_part1_setup_data()
  ...
  for set = 1:length(sets)
      for category = 1:length(categories)
          ...
          for i = 1:length(cur_images)
              ...
              % images.data
              cummulative_image = cummulative_image + cur_image;
  ...
  mean_image = cummulative_image / num_images;
  for i = 1:size(imdb.images.data, 4)
    imdb.images.data(:,:,1,i) = imdb.images.data(:,:,1,i) - mean_image;
  end
end
