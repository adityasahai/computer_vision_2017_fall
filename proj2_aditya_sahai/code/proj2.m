...
% I need the original sized images for get_interest_points()
image1_orig = rgb2gray(image1);
image2_orig = rgb2gray(image2);
...
[x1, y1, orientation1] = get_interest_points(image1_bw, feature_width, image1_orig);
[x2, y2, orientation2] = get_interest_points(image2_bw, feature_width, image2_orig);
...
[image1_features] = get_features(image1_bw, x1, y1, feature_width, orientation1);
[image2_features] = get_features(image2_bw, x2, y2, feature_width, orientation2);
